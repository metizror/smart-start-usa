...
export class TechnologyText extends Component {
    render() {
        return (
            < Container className="aboutus section-padding">
                <div className="container">
                    <div className="row align-items-center">
                        <Row>
                            <Col>
                                <div className="history-title mb-md-40">
                                    ...
                                    <p className="text-light-white">Here at Smart Start US we take data security and privacy very seriously and we continuously look for opportunities to make improvements.</p>
                                    <p className="text-light-white">While it would not be prudent to share too much about what we do to protect our systems (since we would be effectively assisting malicious individuals who might try to compromise them), we can provide some general information about steps we take to keep your Online School and your customers safe.</p>
                                    <p className="text-light-green">Here are the measures we employ for securely storing the data you entrusted to us:</p>
                        ...
                        <div className="text-light-white"> <h6> Protection from Data Loss & Data Corruption</h6>
                            <p> •	Isolated Databases
                            ...
                            <p>•	Customer data regulation
                                We never move any school or user data outside of our secured environment for testing or any other reason. </p>
                        </div>

                        <div className="text-light-white"> <h6> Application Level Security</h6>
                            <p> •	Password salting and hashing Smart Start US uses the most up-to-date and secure cryptographic methods. School Admin Passwords are salted and hashed and never stored or transmitted as plain text. Employees cannot view or manually change passwords. If you forget your password it cannot be retrieved, even by our own CTO – the password must be reset by you.</p>
                            <p> •	Encrypted Data Storage All user passwords are salted and hashed and never stored or transmitted as plain text. We do not store credit card details on our infrastructure. All credit card transactions are processed using secure encryption on a PCI-Compliant network.</p>
                            <p> •	HTTPS everywhere Smart Start US forces all requests over HTTPS, ensuring all traffic between your school and the user’s browser is encrypted. This means that anyone trying to eavesdrop on this data will not be able to decrypt and access the underlying data. Smart Start US uses TLS 1.2 exclusively, throughout its site and subdomains.</p>
                            <p> •	XSS vulnerability avoidance All user inputs are properly treated to ensure that XSS vulnerabilities are avoided.</p>
                        </div>
                        <div className="text-light-white"> <h6> Secure Software Development Life Cycle</h6>
                            <p> •	Vulnerability Scanning & Patching We have automated systems in place that monitor all the software infrastructure that powers Smart Start US for new versions and vulnerabilities. Our infrastructure is updated regularly with the latest security patches. Moreover, our in-house security expert is constantly on the lookout for things that could jeopardize our systems, ready to intervene. We test our systems regularly through simulated attacks from the outside and in.</p>
                            <p> •	Secure File storage Your uploaded files can only be accessed through Smart Start US. Your students can only access files intended for them. Only authorized Smart Start US personnel can access your files, on a strict per-need basis.</p>
                            <p> •	Internal Controls For our employees, access rights and levels are based on job function and role, on a need-to-know basis, match defined responsibilities. All employees must abide by our policies about protecting customer data.</p>
                            <p> •	Security by design Our code is being developed following the latest patterns and industry best practices, and is constantly reviewed. Clear, readable and well-maintained code means secure systems.</p>
                            <p> •	Key management We keep our keys secret and out of version control, to ensure access to critical resources cannot be compromised.</p>
                        </div>
                        <p className="text-light-white"> <h6> Data Center Security</h6>
                        ...
                        <p className="text-light-white"> <h6> Protecting Smart Start US Against rogue or hacked users</h6>
                            ...
                            <p> •	We monitor and will automatically suspend accounts for signs of irregular or suspicious login activity.</p>
                            <p> •	Certain changes to your account, such as to your password, will trigger email notifications to the account owner.</p>
