                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            <div className="history-title mb-md-40">
                                ...
                                <p className="text-light-white"> <div> Protection from Data Loss & Data Corruption</div>
                                    •	Isolated Databases
                                    Each Smart Start US School has its own, isolated Database. This means that even if a School gets compromised or goes rogue, all other Schools will remain unaffected.
                                    •	Regular Backups
                                ...
                                <p className="text-light-white">Application Level Security
                                    ...
                                    •	HTTPS everywhere
                                    Smart Start US forces all requests over HTTPS, ensuring all traffic between your school and the user’s browser is encrypted. This means that anyone trying to eavesdrop on this data will not be able to decrypt and access the underlying data. Smart Start US uses TLS 1.2 exclusively, throughout its site and subdomains.
                                    •	XSS vulnerability avoidance
                                    All user inputs are properly treated to ensure that XSS vulnerabilities are avoided.</p>
                                <p className="text-light-white">Secure Software Development Life Cycle
                                    ...
                                    •	Secure File storage
                                    Your uploaded files can only be accessed through Smart Start US. Your students can only access files intended for them. Only authorized Smart Start US personnel can access your files, on a strict per-need basis.
                                    •	Internal Controls
                                ...
                                <p className="text-light-white">Data Center Security
                                ...
                                <p className="text-light-white">This means that all our servers are located at Google premises, in different world-class data centers around the world:
                                    •	West USA (California)
                                    •	Central USA (Iowa)
                                ...
                                <p className="text-light-white">Protecting Smart Start US Against rogue or hacked users
                                    ...
                                    •	We monitor accounts and school activity for signs of abuse (both via automatic notifications and human reviewers).</p>
